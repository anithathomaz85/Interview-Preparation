...
public class Q028_Q20_Singleton {
	...
	private static Q028_Q20_Singleton mySingletonInstance = null;

	private Q028_Q20_Singleton() {
...
// Synchronized is to ensure only one thread to access this method at a single point of time.
	public synchronized static Q028_Q20_Singleton getInstance() {

		if (mySingletonInstance == null) {
			mySingletonInstance = new Q028_Q20_Singleton();
		}
	...
	public static void main(String[] args) throws CloneNotSupportedException {
		...
		Q028_Q20_Singleton singleton = Q028_Q20_Singleton.getInstance();
		System.out.println(singleton);

		Q028_Q20_Singleton singleton2 = Q028_Q20_Singleton.getInstance();
