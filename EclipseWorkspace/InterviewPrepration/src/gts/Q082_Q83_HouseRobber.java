...
* 
* 
* Example 1: Input: nums = [1,2,3,1] Output: 4 Explanation: Rob house 1 (money
* = 1) and then rob house 3 (money = 3). Total amount you can rob = 1 + 3 = 4.
* Example 2:
* 
...
* 
*/
public class Q082_Q83_HouseRobber {
	...
	public static void main(String[] args) {
		...
		System.out.println("Max you can rob: " + rob(nums1)); // 4
		System.out.println("Max you can rob: " + rob(nums2)); // 12
	}
}